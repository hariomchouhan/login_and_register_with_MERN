...
export default function Profile() {
  ...
  /* formik doesn' support file upload so we need to create this handler */
          ...
          <div className="title flex flex-col items-center">
            ...
            <form className='py-1' onSubmit={formik.handleSubmit}>
              ...
              <div className="text-center py-4">
                <span className='text-gray-500'>come back later?<button to='/' className='text-red-500'>Logout</button></span>
              </div>
            </form>
          </div>
        </div>
